...
try:
    ...
    print("Asegúrese de que los archivos 'poblar_mongo.py', 'poblar_cassandra.py', y 'poblar_dgraph.py' están en la carpeta 'scripts/'.")
...
def poblar_todo():
    ...
    confirmacion = input("¿Desea ELIMINAR los datos existentes antes de poblar? (y/n): ")
